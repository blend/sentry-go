...
func TestSplitQualifiedFunctionName(t *testing.T) {
	tests := []struct {
		...
		{
			"github.com/blend/sentry-go.Init",
			"github.com/blend/sentry-go",
			"Init",
		},
		{
			"github.com/blend/sentry-go.(*Hub).Flush",
			"github.com/blend/sentry-go",
			"(*Hub).Flush",
		},
		{
			"github.com/blend/sentry-go.Test.func2.1.1",
			"github.com/blend/sentry-go",
			"Test.func2.1.1",
		},
		{
			...
			in: []Frame{
				{
					...
					Module:   "github.com/blend/sentry-go/http/integration",
					AbsPath:  "/somewhere/sentry/sentry-go/http/integration/integration.go",
					InApp:    true,
				},
				{
					Function: "(*Handler).Handle",
					Module:   "github.com/blend/sentry-go/http",
